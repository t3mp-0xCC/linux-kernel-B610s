 ...
 * 2014-08-26 -        add dump_set_exc_vec deal in do_DataAbort function
 *                     add dump_set_exc_vec deal in do_PrefetchAbort function
...
do_DataAbort(unsigned long addr, unsigned int fsr, struct pt_regs *regs)
{
    ...
    ap_dump_set_exc_vec(EXC_VEC_DATA);
...
#ifdef CONFIG_HISI_DUMP
	/* 20140826 MNTN_DUMP BEGIN */
    ap_dump_set_exc_vec(EXC_VEC_PREFETCH);
	/* 20140826 MNTN_DUMP END */
#endif
