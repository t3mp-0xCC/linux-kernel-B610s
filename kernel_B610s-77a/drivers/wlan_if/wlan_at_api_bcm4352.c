...
#define WLAN_AT_MODE_BCM4352_SUPPORT    "1,2,3,4,5"        /*支持的模式(a/b/g/n/ac)*/    
             
#define WLAN_AT_BCM4352_BAND_SUPPORT    "0,1,2"            /*支持的带宽(20M/40M/80M/160M)*/

#define WLAN_AT_TSELRF_SUPPORT          "0,1,2,3"          /*支持的天线索引序列*/

#define WLAN_AT_GROUP_MAX               3                  /*支持的最大天线索引*/
...
/*****************************************************************************
 函数名称  : int32 ATGetInitWifi2GPavars(WLAN_AT_BUFFER_STRU *strBuf)
 功能描述  : 2.4G射频参数查询封装函数
 输入参数  : WLAN_AT_BUFFER_STRU *strBuf AT命令返回字符串
 输出参数  : NA
 返 回 值  : NA
 其他说明  : 
*****************************************************************************/
...
/*****************************************************************************
 函数名称  : int32 ATGetInitWifi5GPavars(WLAN_AT_BUFFER_STRU *strBuf)
 功能描述  : 5G射频参数查询封装函数
 输入参数  : WLAN_AT_BUFFER_STRU *strBuf AT命令返回字符串
 输出参数  : NA
 返 回 值  : NA
