...
typedef enum _DLOAD_MODULE
{
    ...
    DLOAD_SEC_MODULE,     /* 安全升级模块 */
}dload_module_t;

/* 交互消息ID定义列表 */
enum _MAIN_MODULE_MSG_ID
{
    MTD_FLUSH_MSG_ID = 0,           /* 刷新MTD设备 */
    GET_BAT_LEVEL_MSG_ID = 1,       /* 获取电池电量格数 */
    GET_PLATFORMINFO_MSG_ID = 2,    /* 获取平台信息 */
    VISIT_DLOAD_SMEM_MSG_ID = 3,    /* 共享内存访问消息ID*/
    GET_MTD_FS_TYPE_MSG_ID = 4,     /* 获取MTD文件系统类型 */
    GET_DLOAD_FEATURE_MSG_ID = 5,   /* 获取升级特性信息 */
    GET_PATH_INFO_SIZE_MSG_ID = 6,  /* 获取显示模块路径映射表大小 */
    GET_PATH_INFO_MSG_ID = 7,       /* 获取显示模块路径映射表 */
    GET_SHOW_INFO_SIZE_MSG_ID = 8,  /* 获取显示模块运行列表大小 */
    GET_SHOW_INFO_MSG_ID = 9,       /* 获取显示模块运行列表 */
    SET_DOUBLE_PART_FLAG = 10,      /*设置双备份特性标志*/
    GET_IMG_PUB_KEY_ID = 11,        /* 获取镜像签名对应的公钥 */
};
...
typedef struct _DLOAD_SMEM_INFO
{
    ...
    void*  datalock_status_addr;       /* datalock 解锁标识 */
    void*  dt_dload_addr;              /*dt升级标识*/
    void*  smem_reserve4;
    void*  smem_reserve3;
    void*  smem_reserve2;
    void*  smem_reserve1;
