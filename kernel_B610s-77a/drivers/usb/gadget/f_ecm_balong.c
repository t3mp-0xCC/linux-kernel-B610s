...
ecm_unbind(struct usb_configuration *c, struct usb_function *f)
{
    ...
    bsp_usb_del_setup_dev((unsigned)ecm->data_id);
...
static inline void ecm_set_config_vendor(void)
{
    ...
    ecm_control_intf.bInterfaceSubClass = bsp_usb_pc_driver_subclass_get();
    ecm_control_intf.bInterfaceProtocol = 0x07;

    ecm_data_intf.bInterfaceClass = 0xFF;
    ecm_data_intf.bInterfaceSubClass = bsp_usb_pc_driver_subclass_get();
    ecm_data_intf.bInterfaceProtocol = 0x07;
    ecm_data_intf.bNumEndpoints = 3;

    ecm_data_nop_intf.bInterfaceClass = 0xFF;
    ecm_data_nop_intf.bInterfaceSubClass = bsp_usb_pc_driver_subclass_get();
