...
#define FSG_MAX_CONFIGS                      1
#define FILE_NAME_LEN   32
#define FSG_QUEUE_SIZE  4
#define FSG_RX_SIZE  1
#define FSG_IO_BUF_COUNT  2
...
struct fsg_common
{
    ...
    enum fsg_file_op_event file_op;        /*used for RX main_thread*/
    struct list_head			rx_req_pool;
    struct list_head			tx_req_pool;
    struct list_head			rx_pool;
    struct list_head			tx_pool;
    struct list_head                  rx_queue;
    struct usb_request*	throw_data_req;	/*throw_data_req */
    struct spinlock			rx_lock;
    struct spinlock			tx_lock;
    USB_INT                            thread_need_wakeup;
    void*                                 csw_buf;
    void*			             	rx_buf;
#ifdef FSG_BUFFHD_STATIC_BUFFER
    char				 buf[FSG_BUFLEN];
