...
#ifndef MBB_NV_DISABLED
#define MBB_NV_DISABLED             (0)
#endif
...
#ifndef MBB_USB_DISABLE
#define MBB_USB_DISABLE         (0)
#endif

#ifndef MBB_USB_ENABLE
#define MBB_USB_ENABLE          (1)
#endif
...
#define __nametostring_1(x...)	#x
#define __nametostring(x...)	__nametostring_1(x)
...
#define GUSB_MAX_CONFIG       (3)
#else  /*#if (FEATURE_ON == MBB_USB_MULTICONFIG)*/
#define GUSB_MAX_CONFIG       (1)
#endif /*#if (FEATURE_ON == MBB_USB_MULTICONFIG)*/
