...
USB_INT32 rndis_msg_parser(USB_UINT8 configNr, USB_UINT8 *buf)
{
    ...
    case REMOTE_NDIS_INITIALIZE_MSG:
        DBG_I(MBB_RNDIS, "%s: REMOTE_NDIS_INITIALIZE_MSG\n",
            __func__);
                usb_notify_syswatch(EVENT_DEVICE_USB,USB_INIT_EVENT);
        params->state = RNDIS_INITIALIZED;
    ...
    case REMOTE_NDIS_HALT_MSG:
        DBG_I(MBB_RNDIS, "%s: REMOTE_NDIS_HALT_MSG\n",
            __func__);
                usb_notify_syswatch(EVENT_DEVICE_USB,USB_HALT_EVENT);
    ...
    case REMOTE_NDIS_RESET_MSG:
        DBG_I(MBB_RNDIS, "%s: REMOTE_NDIS_RESET_MSG\n",
            __func__);
        usb_notify_syswatch(EVENT_DEVICE_USB,USB_RESET_EVENT);
    ...
    default:
        ...
        print_hex_dump_bytes(__func__, DUMP_PREFIX_OFFSET, buf, MsgLength);
        break;
    }
