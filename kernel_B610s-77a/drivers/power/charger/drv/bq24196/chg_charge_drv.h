...
#define VBUS_JUDGEMENT_THRESHOLD     484     /*DC04 VBUS判断的门限值0.4834V*/
#else
#define VBUS_JUDGEMENT_THRESHOLD     700     /*VBUS判断的门限值0.7V*/
#endif
/*充电电流相关宏*/
...
Description:    设定充电芯片对电池的充电电流,兼容BQ24296M及高压电池特性
Input:          1、chg_cur：充电电流值
                2、设置是否使能设定充电芯片对电池的充电电流的20%标记
Output:         N/A
Return:         TRUE     : 函数执行成功
                FALSE    : 函数执行失败
Others:         N/A
