...
#ifdef CONFIG_MMC_FOR_BALONG_H
	int	(*start_signal_voltage_switch)(struct dw_mci *host, int signal_voltage);
	int (*execute_tuning)(struct dw_mci_slot *slot, u32 opcode,
					struct dw_mci_tuning_data *tuning_data);
	int (*resume)(struct dw_mci_slot *slot);
	int (*suspend)(struct dw_mci_slot *slot);
	void (*resume_pin)(struct dw_mci_slot *slot);
