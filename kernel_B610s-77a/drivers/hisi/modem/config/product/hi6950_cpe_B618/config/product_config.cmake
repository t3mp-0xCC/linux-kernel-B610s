...
set(CFG_PRODUCT_TYPE cpe) 

set(CFG_PRODUCT_NAME "hi6950_cpe_B618") 

set(CFG_PRODUCT_CFG_CHIP_SOLUTION_NAME "Balong") 

set(CFG_BUILD_TYPE RELEASE) 

set(CFG_PRODUCT_VERSION V700R500C31B192) 

set(CFG_PRODUCT_VERSION_STR "V700R500C31B192") 

set(CFG_PRODUCT_FULL_VERSION_STR "Balong V700R500C31B192") 

set(CFG_PRODUCT_FILE_VERSION_STR "2.1.6.8") 

set(CFG_PRODUCT_DLOAD_SOFTWARE_VER "11.192.01.00.00") 

set(CFG_PRODUCT_CFG_DLOAD_KIND FW_WEB_HIFI) 

set(CFG_PRODUCT_CFG_DLOAD_ID B618__0) 

set(CFG_PRODUCT_CFG_DLOAD_ID_DEBUG B618) 

set(CFG_PRODUCT_CFG_DLOAD_NAME B618) 

set(CFG_PRODUCT_DLOAD_DASHBOARD_VER UTPS22.001.25.00.03) 

set(CFG_PRODUCT_DLOAD_WEBUI_VER WEBUI_21.100.34.00.03_CPE) 

set(CFG_PRODUCT_DLOAD_SIGN_KEY_NAME "P722s_B520_PUBLIC.key") 

set(CFG_PRODUCT_DLOAD_SIGN_KEY_ID "/root/key/B520/updateapp_key") 
...
set(CFG_OS_PATH modem/config/product/hi6950_cpe_B618/os) 
...
set(CFG_OS_LINUX_PRODUCT_NAME hi6950_cpe_B618_defconfig) 

set(CFG_TARGET_BALONG_PRODUCT hi6950_cpe_B618) 
...
set(CFG_PRODUCT_NV_XNV_PDT_VERSION hi6950_cpe) 
...
set(CFG_BSP_CONFIG_BOARD_CPE YES) 

set(CFG_BSP_CONFIG_BOARD_CPE_B618 YES) 
...
set(CFG_CONFIG_DDR_AUTOSREF NO) 
...
set(CFG_CONFIG_AMON_FOR_BUS_LOCK NO) 
...
set(CFG_PRODUCT_CFG_PTABLE_VER_NAME "V7R500_CPE") 
...
set(CFG_PRODUCT_CFG_FLASH_RECOVERY_LEN 0x800000) 

set(CFG_PRODUCT_CFG_FLASH_MULTI_CARRIER_LEN 0x00000) 

set(CFG_MBB_PTABLE_M3BOOT_LEN (0x80000)) 

set(CFG_MBB_PTABLE_FASTBOOT_LEN (0x80000)) 

set(CFG_MBB_PTABLE_NVBACK_LEN (0x300000)) 

set(CFG_MBB_PTABLE_NVDEFAULT_LEN (0x300000)) 

set(CFG_MBB_PTABLE_NVIMAGE_LEN (0xF00000)) 

set(CFG_MBB_PTABLE_NVDLOAD_LEN (0x500000)) 

set(CFG_MBB_PTABLE_NVUPDATE_LEN (0x000000)) 

set(CFG_MBB_PTABLE_NVSYS_LEN (0x000000)) 

set(CFG_MBB_PTABLE_OEMINFO_LEN (0x300000)) 

set(CFG_MBB_PTABLE_KERNEL_LEN (0xC00000)) 

set(CFG_MBB_PTABLE_KERNELBK_LEN (0xC00000)) 

set(CFG_MBB_PTABLE_DTIMG_LEN (0x200000)) 

set(CFG_MBB_PTABLE_DTIMGBK_LEN (0x000000)) 

set(CFG_MBB_PTABLE_LOGO_LEN (0x000000)) 

set(CFG_MBB_PTABLE_M3IMAGE_LEN (0x140000)) 

set(CFG_MBB_PTABLE_M3IMAGEBK_LEN (0x000000)) 

set(CFG_MBB_PTABLE_DSP_LEN (0x800000)) 

set(CFG_MBB_PTABLE_HIFI_LEN (0x500000)) 

set(CFG_MBB_PTABLE_MISC_LEN (0x000000)) 

set(CFG_MBB_PTABLE_VXWORK_LEN (0x1000000)) 

set(CFG_MBB_PTABLE_RESERVE1_LEN (0x200000)) 

set(CFG_MBB_PTABLE_RESERVE2_LEN (0x6C0000)) 

set(CFG_MBB_PTABLE_RESERVE3_LEN (0x500000)) 

set(CFG_MBB_PTABLE_FOTA_LEN (0x000000)) 

set(CFG_MBB_PTABLE_OM_LEN (0xC00000)) 

set(CFG_MBB_PTABLE_WEBSDK_LEN (0x1E00000)) 

set(CFG_MBB_PTABLE_WEBUI_LEN (0x3C00000)) 

set(CFG_MBB_PTABLE_SYSTEM_LEN (0x3200000)) 

set(CFG_MBB_PTABLE_USERDATA_LEN (0x1400000)) 

set(CFG_MBB_PTABLE_BBOU_LEN (0xE600000)) 

set(CFG_MBB_PTABLE_MMC_LEN (0x000000)) 

set(CFG_MBB_PTABLE_CACHE_LEN (0x000000)) 

set(CFG_MBB_PTABLE_RECVA_LEN (0x000000)) 

set(CFG_MBB_PTABLE_RECVB_LEN (0x000000)) 

set(CFG_MBB_PTABLE_COREDUMP_LEN (0xA00000)) 
...
set(CFG_ONCHIP_FASTBOOT_ADDR 0x4F400000) 
...
set(CFG_LPHY_TEXT_START_ADDR 0x40180000) 
...
set(CFG_FEATURE_DTMF FEATURE_OFF) 
...
set(CFG_FEATURE_KEYBOARD FEATURE_ON) 
