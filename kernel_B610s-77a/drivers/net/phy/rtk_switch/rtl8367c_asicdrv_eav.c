...
ret_t rtl8367c_setAsicEavPortInterruptStatus(rtk_uint32 port, rtk_uint32 ims)
{
	...
	if(port < 5)
    	...
    	return rtl8367c_setAsicRegBits(RTL8367C_REG_P6_EAV_CFG+(port<<4), RTL8367C_PTP_INTR_MASK,ims);
...
ret_t rtl8367c_getAsicEavPortInterruptStatus(rtk_uint32 port, rtk_uint32* pIms)
{
	...
	if(port < 5)
    	...
    	return rtl8367c_getAsicRegBits(RTL8367C_REG_P6_EAV_CFG+(port<<4), RTL8367C_PTP_INTR_MASK,pIms);
...
ret_t rtl8367c_setAsicEavPortEnable(rtk_uint32 port, rtk_uint32 enabled)
{
	...
	if(port < 5)
    	...
    	return rtl8367c_setAsicRegBits(RTL8367C_REG_P6_EAV_CFG+((port-6)<<4), RTL8367C_EAV_CFG_PTP_PHY_EN_EN_OFFSET,enabled);
...
ret_t rtl8367c_getAsicEavPortEnable(rtk_uint32 port, rtk_uint32 *pEnabled)
{
	...
	if(port < 5)
    	...
    	return rtl8367c_getAsicRegBits(RTL8367C_REG_P6_EAV_CFG+((port-6)<<4), RTL8367C_EAV_CFG_PTP_PHY_EN_EN_OFFSET,pEnabled);
...
ret_t rtl8367c_getAsicEavPortTimeStamp(rtk_uint32 port, rtk_uint32 type, rtl8367c_ptp_time_stamp_t* timeStamp)
{
	...
	if(port < 5){
	    ...
	    if((retVal = rtl8367c_getAsicReg(RTL8367C_REG_P6_TX_SYNC_SEQ_ID + type + ((port-6)<<4), &timeStamp->sequence_id))!=  RT_ERR_OK)
	        return retVal;
	    if((retVal = rtl8367c_getAsicReg(RTL8367C_REG_P6_PORT_SEC_31_16 + ((port-6)<<4) , &sec_h)) != RT_ERR_OK)
	       return retVal;
	    if((retVal = rtl8367c_getAsicReg(RTL8367C_REG_P6_PORT_SEC_15_0 + ((port-6)<<4), &sec_l)) != RT_ERR_OK)
	       return retVal;
	    if((retVal = rtl8367c_getAsicRegBits(RTL8367C_REG_P5_PORT_NSEC_26_16 + ((port-6)<<4) , RTL8367C_PORT_NSEC_H_MASK,&nsec8_h)) != RT_ERR_OK)
	       return retVal;
	    if((retVal = rtl8367c_getAsicReg(RTL8367C_REG_P5_PORT_NSEC_15_0 + ((port-6)<<4) , &nsec8_l)) != RT_ERR_OK)
	       return retVal;
	}
