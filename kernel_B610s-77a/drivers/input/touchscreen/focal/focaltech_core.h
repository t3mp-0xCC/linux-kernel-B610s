...
/*add by wanghaijie for focal test*/
#include "product_config.h"

/*******************************************************************************
* Private constant and macro definitions using #define
*******************************************************************************/
#define FTS_DRIVER_INFO  "Hisi_focal Ver 1.3.1 2015-07-06"
...
static int FTS_IS_FW_UPLOADING  = 0;
...
//extern int fts_gpio_request_config(bool flag);
