...
#ifdef CONFIG_ATP_ROUTE
#define sk_bound_in_fromlan   __sk_common.skc_bound_in_fromlan
#endif
...
#define LIMIT_NETDEBUG(fmt, args...) \
 ...
 //°ó¶¨¹Ø×¢lan¼°lo
   #define IS_LAN_LO_DEVICE(dev_name) \
   (('b' == dev_name[0]) || (('l' == dev_name[0]) && ('o' == dev_name[1])))
