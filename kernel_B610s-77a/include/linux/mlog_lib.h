...
extern int mlog_state_set(unsigned char ucstate);
extern int mlog_state_get(unsigned char *pucstate);
extern unsigned int mlog_get_memory_flag(void);
#endif
