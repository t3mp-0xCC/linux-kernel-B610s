 ...
 * 2014-11-20 - add branch if (c->mtd->type ==MTD_NANDFLASH) , controlled with macro 
 * CONFIG_JFFS2_BADBLOCK_BALONG, in function  
 * jffs2_flash_cleanup() and jffs2_flash_setup(). Copyright (C) Huawei Technologies Co., Ltd. 
