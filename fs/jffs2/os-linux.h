 ...
 *
 * 2014-11-20 - add macro defination #define jffs2_cleanmarker_oob(c) (0), controlled by macro 
 * CONFIG_JFFS2_BADBLOCK_BALONG. Copyright (C) Huawei Technologies Co., Ltd. 
