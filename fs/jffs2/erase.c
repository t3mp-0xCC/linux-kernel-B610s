 ...
 *
 * 2014-11-20 - add branch if ((c->mtd->type ==MTD_NANDFLASH) && (bad_offset != 
 * (uint32_t)MTD_FAIL_ADDR_UNKNOWN)), controlled with macro CONFIG_JFFS2_BADBLOCK_BALONG, in function  
 * jffs2_erase_failed(). Copyright (C) Huawei Technologies Co., Ltd. 
...
#ifdef CONFIG_JFFS2_BADBLOCK_BALONG
