 ...
 * 
 * 2014-11-20 - add else branch of if (jffs2_cleanmarker_oob(c)), controlled with macro 
 * CONFIG_JFFS2_BADBLOCK_BALONG, in function jffs2_scan_eraseblock(). Copyright (C) Huawei Technologies Co., * Ltd. 
