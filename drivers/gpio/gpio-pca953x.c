...
2014-07-03 - delete gpioex register configure liuwenhui <anna.liuwenhui@notesmail.huawei.com>*/
...
#ifndef CONFIG_PCA957X_NOINIT_BALONG /* ¸Ã´úÂë»áÓ°ÏìfastbootÀ©Õ¹gpioÅäÖÃ£¬¹Ê×¢µô */
				   ...
				   const struct i2c_device_id *id)
{
	...
	if (ret){
		dev_err(&client->dev,"pca 9537 add gpio chip fail, ret=%d\n", ret);
		return ret;
	}
