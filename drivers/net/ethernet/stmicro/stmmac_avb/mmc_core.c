...
#define MMC_CNTRL		0x00000700	/* MMC Control */
#define MMC_RX_INTR		0x00000704	/* MMC RX Interrupt */
#define MMC_TX_INTR		0x00000708	/* MMC TX Interrupt */
#define MMC_RX_INTR_MASK	0x0000070C	/* MMC Interrupt Mask */
#define MMC_TX_INTR_MASK	0x00000710	/* MMC Interrupt Mask */
...
/* IPC*/
#define MMC_RX_IPC_INTR_MASK	0x00000800
#define MMC_RX_IPC_INTR			0x00000808
/* IPv4*/
