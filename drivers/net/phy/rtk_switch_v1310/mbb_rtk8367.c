...
/*软银定制灯常亮，数传也不闪，烧片版本需要闪*/
    ...
    /* CPU rgmii起来后，对lan switch进行一次软复位 */
    LAN_DEBUG("rtk reset buffer\n");
    rtl8367c_setAsicRegBit(RTL8367C_REG_BUFF_RST_CTRL0, 2, 1);
    mdelay(100);
    rtl8367c_setAsicRegBit(RTL8367C_REG_BUFF_RST_CTRL0, 2, 0);
