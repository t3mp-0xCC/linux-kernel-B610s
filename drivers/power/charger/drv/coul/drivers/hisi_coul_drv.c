...
/****************************************************************************
  Function:     hisi_battery_removal_handle()
  Description:  Handle function while battery removal detected.
  Input:        NA
  Output:       NA
  Return:       NA
****************************************************************************/
void hisi_battery_removal_handle(void)
{
    /*declare the local variable of struct hisi_coul_ops*/
    LOCAL_HISI_COUL_OPS();

    /*execute the operation of coul module*/
    if (ops && ops->battery_removal_handle){
        ops->battery_removal_handle();
    }
}
