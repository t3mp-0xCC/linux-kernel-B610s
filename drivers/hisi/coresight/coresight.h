...
extern void coresight_set_path_to_enable(struct coresight_device * csdev);
extern void coresight_get_path_status(struct coresight_device * csdev);
#else
...
extern struct clk *coresight_get_clk(void) {};
static inline void coresight_set_path_to_enable(struct coresight_device * csdev) {}
static inline void coresight_get_path_status(struct coresight_device * csdev) {}
#endif
