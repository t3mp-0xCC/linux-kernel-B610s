...
#if (FEATURE_ON == MBB_COMMON)
typedef OM_BATTREY_TEMP_CFG_STRU NV_BATTERYTEMP_CFG_STRU;
#endif
...
typedef struct
{
    ...
    VOS_UINT32                          ulSelectParaCheck       : 1;  /* TS27 不需要检查此参数有效性 */
    VOS_UINT32                          ulOpenChParaCheck       : 1;  /* TS27 不需要检查此参数有效性 */
    VOS_UINT32                          ulSlectAidSupport       : 1;  /* TS27 设置成 TRUE*/
    VOS_UINT32                          ulSsaveVerify           : 1;  /* TS27 设置成 TRUE*/
    VOS_UINT32                          ulTpduGetRspSw          : 1;  /* TS27 设置成 TRUE 使用最终的SW*/
