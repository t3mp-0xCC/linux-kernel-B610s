...
enum TAF_NV_CLIENT_CFG_ENUM
{
    ...
    TAF_NV_CLIENT_CFG_CMUXAT            = 49,
    TAF_NV_CLIENT_CFG_CMUXMDM           = 50,
    TAF_NV_CLIENT_CFG_CMUXEXT           = 51,
    TAF_NV_CLIENT_CFG_CMUXGPS           = 52,
    TAF_NV_CLIENT_CFG_CMUXECL           = 53,
    TAF_NV_CLIENT_CFG_GPS               = 54,
#endif
