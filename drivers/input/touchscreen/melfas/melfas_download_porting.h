...
#define TKEY_VDD_SET_HIGH()             			____HERE!_____
#define TKEY_VDD_SET_LOW()              			____HERE!_____
#else
...
#define TKEY_INTR_SET_HIGH()             			____HERE!_____
#define TKEY_INTR_SET_LOW()              			____HERE!_____
#define TKEY_INTR_SET_OUTPUT()             			____HERE!_____
#define TKEY_INTR_SET_INPUT()             			____HERE!_____
#else
#define TKEY_INTR_SET_HIGH()              											// Nothing
#define TKEY_INTR_SET_LOW()            												// Nothing
#define TKEY_INTR_SET_OUTPUT()             											// Nothing
...
#define TKEY_I2C_SCL_SET_HIGH()						//____HERE!_____
#define TKEY_I2C_SCL_SET_LOW()						//____HERE!_____

#define TKEY_I2C_SDA_SET_HIGH()						//____HERE!_____
#define TKEY_I2C_SDA_SET_LOW()						//____HERE!_____

#define TKEY_I2C_SCL_SET_OUTPUT()					//____HERE!_____
#define TKEY_I2C_SDA_SET_OUTPUT()					//____HERE!_____
