...
#define NCMPORT_RD_SKB_SIZE             (0x4000)
#define MBB_SPE_USB_RD_TD_DEPTH 64
#endif
...
typedef struct
{
    ...
    USB_ULONG tx_quirk;
    USB_ULONG tx_spe_total;
    USB_ULONG tx_queue;
    USB_ULONG tx_spe_send;
    USB_ULONG tx_spe_rd_config;
    USB_ULONG tx_spe_no_req;
    USB_ULONG tx_spe_complete_ok;
    USB_ULONG tx_packet_from_host;
    USB_ULONG tx_spe_complete_fail;
...
struct eth_dev_ctx
{
    USB_INT offset;/*point to eth_idx for om*/
    USB_UINT eth_idx;
...
struct eth_dev
{
    ...
    USB_INT (*get_wrap_format)(struct gether *);
...
#if (defined(CONFIG_BALONG_SPE) || defined(CONFIG_BALONG_SPE_MODULE))
    USB_UINT spe_port_num;
	struct sk_buff_head spe_td_pending;
#endif    
};
...
struct gether
{
    ...
    USB_UINT (*get_wrap_format)(struct gether *port);
...
USB_INT rndis_bind_config_vendor(struct usb_configuration* c, USB_UINT8 ethaddr[ETH_ALEN],
                                 USB_UINT32 vendorID, const USB_CHAR* manufacturer,struct eth_dev *dev);
